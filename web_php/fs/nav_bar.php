...
<div class="htmleaf-container" style="margin-left:10%;width:80%;margin-top: 80px;">
	<nav class="animenu"> 
	  ...
	  <ul class="animenu__nav">
		<li>
		  <a href="/web_bcg/fs/main/main_devices.php">我的设备</a>
		</li>
		<li>
		  <a href="#">设&nbsp;备&nbsp;</a>
		  <ul class="animenu__nav__child">
			<li><a href="/web_bcg/fs/main/manager_devices.php">设备管理</a></li>
			<li><a href="/web_bcg/fs/main/create_devices_id.php">设备ID</a></li>
			<!-- <li><a href="">绑定ID</a></li> -->
		  </ul>
		</li>     
		<li>
		  ...
		  <ul class="animenu__nav__child">			
			...
			<li>
		  	<?php	
				...
				if(isset($_SESSION["username"])){
					...
					echo "<ul class=\"animenu__nav__child\">";
						echo 	"<li>";
						echo "<a href=\"../login/logout.php\">退出</a>";	
					...
					echo "<ul class=\"animenu__nav__child\">";
						echo 	"<li>";
						echo 	"<a href=\"../login/login.php\">登录</a>";							
						echo 	" </li>";
					echo "</ul>";						
				}
			?>
			...
			<li>		
		 <a href="/web_bcg/fs/main/help.php" >帮助</a>	
		</li>
	  </ul>
	</nav>
</div>
